  ...
  try {
    for (var idx in nifty) {
      ...
      for (var sht = 0; sht < sheets.length; sht++) {
        ...
        const url =
          "https://www.tickertape.in/stocks/" + item + "/financials?checklist=basic&statement=" + sheets[sht] + "&view=normal&period=annual";
        ...
        for (var j = 0; j < colData[0].length; j++) {
          try {
            ...
            console.log(idx + ' :' + sheets[sht] + ' :' + cat + ' :' + yr0+ ' :' + yr1+ ' :' + yr2+ ' :' + yr3 + ' :' + yr4+ ' :' + yr5+ ' :' + yr6 + ' :' + yr7 + ' :' + yr8 + ' :' + yr9);
          } catch (error) {
