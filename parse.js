...
for (var tweet in json.globalObjects.tweets) {
    ...
    console.log('url : ', 'https://twitter.com/nsdevaraj/status/'+json.globalObjects.tweets[tweet].id_str)
    ...
    try {
        ...
        console.log('profile image : ', json.globalObjects.users[userid].profile_image_url_https); console.log('media : ', json.globalObjects.tweets[tweet].entities.media[0].media_url_https)
    } catch (error) {
